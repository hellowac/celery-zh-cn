...
def prepare_intersphinx_mapping(project, mapping, include, exclude, **extra):
    if include:
...
def build_config(
    ...
    **kwargs,
    ...
    conf = dict(
        ...
        man_pages=[
            (master_doc, project.lower(), f"{project} Documentation", [author_name], 1)
        ],
        ...
        html_theme=html_theme,  # 'sphinx_celery',
        html_sidebars={
